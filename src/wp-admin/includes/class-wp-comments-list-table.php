...
class WP_Comments_List_Table extends WP_List_Table {
	...
	protected function get_views() {
		...
		//, number_format_i18n.php($num_comments->moderated) ), "<span class='comment-count'>" . number_format_i18n.php($num_comments->moderated) . "</span>"),
		//, number_format_i18n.php($num_comments->spam) ), "<span class='spam-comment-count'>" . number_format_i18n.php($num_comments->spam) . "</span>")
		$stati = array(
